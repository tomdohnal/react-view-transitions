...
export default function ReviewCard({
  ...
  return (
    <ViewTransition
      default="card"
      name={getCardTransitionName(review.avatarInitials)}
    >
      <div className="bg-gray-800 p-4 rounded-lg">
        <ViewTransition
          default="card-content"
          name={getProfileCardContentTransitionName(review.avatarInitials)}
        >
          <div>
            <div className="flex items-center mb-2">
              <ViewTransition
                name={getAvatarContainerTransitionName(review.avatarInitials)}
              >
                <span
                ...
                >
                  <ViewTransition
                    name={getAvatarInitialsTransitionName(
